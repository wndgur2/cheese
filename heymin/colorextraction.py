...
'''
img_ref = load_img_file('C:/Users/goaeh/Desktop/블로그/56/2.jpeg')
#img_src = load_img_file('C:/Users/goaeh/Desktop/블로그/56/1.jpg')

cm = ColorMatcher()
img_res = cm.transfer(src=img_src, ref=img_ref, method='default')
save_img_file(img_res, 'C:/Users/goaeh/Desktop/color_matcher/defaultresult.png')

img_res = cm.transfer(src=img_src, ref=img_ref, method='hm-mkl-hm')
save_img_file(img_res, 'C:/Users/goaeh/Desktop/color_matcher/hm-mkl-hmresult.png')
'''
