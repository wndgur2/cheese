...
def main():
    ...
    #target_path = f'{session_dir}/target.png'
    ...
    if os.path.exists(original_path) or os.path.exists(inpainted_path):
        ...
        if value is not None:
            ...
            print("original_image 크기:", original_image.shape)
            print("mask 크기:", mask.shape)
            print("original_image 데이터 유형:", original_image.dtype)
            print("mask 데이터 유형:", mask.dtype)
