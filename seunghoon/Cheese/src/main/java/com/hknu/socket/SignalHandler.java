...
public class SignalHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(
        ...
        try {
            ...
            System.out.println(String.format("[ws] Message of {} type from {} received", message.getType(), message.getFrom()));
            ...
            switch (message.getType()) {
                ...
                case MSG_TYPE_TEXT:
                    System.out.println(String.format("[ws] Text message: {}", message.getData()));
                ...
                case MSG_TYPE_ICE:
                    ...
                    System.out.println(String.format("[ws] Signal: {}",
                            candidate != null
                ...
                case MSG_TYPE_JOIN:
                    ...
                    System.out.println(String.format("[ws] {} has joined Room: #{}", userName, message.getData()));
                ...
                case MSG_TYPE_LEAVE:
                    // message data contains connected room id
                    System.out.println(String.format("[ws] {} is going to leave Room: #{}", userName, message.getData()));
                ...
                default:
                    System.out.println(String.format("[ws] Type of the received message {} is undefined!", message.getType()));
